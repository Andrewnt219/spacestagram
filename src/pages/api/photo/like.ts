...
export type Photo_Like_GetData = TResultSuccess<GetData>;
export type Photo_Like_GetQuery = Pick<PhotoLike, 'photo_id' | 'user_id'>;
...
const validateQuery: ValidateQuery<Photo_Like_GetQuery> = (query) => {
  const castedQuery = query as Photo_Like_GetQuery;
